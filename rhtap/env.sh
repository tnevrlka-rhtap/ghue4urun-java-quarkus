...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/ghue4urun-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-qbdtd.qbdtd.sandbox1382.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-qbdtd.qbdtd.sandbox1382.opentlc.com}
